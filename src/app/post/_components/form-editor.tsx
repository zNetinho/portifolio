        ...
        <div className='flex gap-2 flex-wrap'>
            <div className='w-full flex gap-2'>
                ...
                <div className='w-1/2'>
                    ...
                    <Input type='text' className='py-1 px-1' value={description_post? description_post : description_post_fetched} onChange={(e) => setDescription_post(e.target.value)}/>
                </div>
            </div>
            <div className='w-full flex gap-2'>
                <div className='w-1/2'>
                    <Label>URL (slug)</Label>
                    <Input type='text' className='py-1 px-1' value={slug_post? slug_post : slug_post_fectched} onChange={(e) => setSlug_post(e.target.value)}/>
                </div>
            </div>
        </div>
    </>
